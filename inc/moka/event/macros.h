...
_MOKA_SIGNAL_CONNECT_BASE(signal, object, callback)), id)
#define _MOKA_SIGNAL_CONNECT_1ARGS(signal, id, object, callback) \
_MOKA_SIGNAL_CONNECT_BASE(signal, object, callback), std::placeholders::_1), id)
#define _MOKA_SIGNAL_CONNECT_2ARGS(signal, id, object, callback) \
_MOKA_SIGNAL_CONNECT_BASE(signal, object, callback), std::placeholders::_1, std::placeholders::_2), id)
#define _MOKA_SIGNAL_CONNECT_3ARGS(signal, id, object, callback) \
_MOKA_SIGNAL_CONNECT_BASE(signal, object, callback), std::placeholders::_1, std::placeholders::_2, std::placeholders::_3), id)
#define _MOKA_SIGNAL_CONNECT_4ARGS(signal, id, object, callback) \
_MOKA_SIGNAL_CONNECT_BASE(signal, object, callback), std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4), id)
